...
#define Rear5 ((Odrv_Sendqueue.Rear + 1) % CAN_QUEUESIZE)
...
extern Can_QueueTypeDef Can_Sentqueue, Can2_Sendqueue, Can1_Sendqueue, VESC_Sendqueue, AK_Sendqueue, Odrv_Sendqueue;

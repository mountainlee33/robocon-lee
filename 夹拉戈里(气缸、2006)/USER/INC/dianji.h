...
enum MOTOR_MODE { duty=0, current, RPM, brake, zero, position, vesc_postion_rpm, vesc_postion_I ,vesc_postion_Current,vesc_RPM_I};
enum MOTOR_TYPE{M2006,M3508};
...
typedef struct{
	...
	vu16 stuckCnt;//堵转用计数值，（堵转状态stuck）

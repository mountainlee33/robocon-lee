...
void VESC_Init(void)
{
	...
	VESClimit.BrakeCurrent = 3000.f;//刹车电流
	VESCargum.stuckTicks = 100; //100ms
	VESCargum.timeoutTicks = 40;
	VESCargum.stopTicks = 5;
	VESClimit.stuckmotion = 0;	 //开启堵转判断
...
void VESC_position_mode_pos(u8 id)
{
	...
	{
		if (VESCmotor[id].status.stop_flag == 0)
		{
...
void VESC_Set_Pos(u8 controller_ID, float pos, u8 InConGrpFlag)
{
	...
	VESC_Sendqueue.Can_DataSend[VESC_Sendqueue.Rear].ID = 0xf0000000 | controller_ID | ((u32)CAN_PACKET_SET_POS << 8);
	VESC_Sendqueue.Can_DataSend[VESC_Sendqueue.Rear].DLC = send_index;
	VESC_Sendqueue.Can_DataSend[VESC_Sendqueue.Rear].InConGrpFlag = InConGrpFlag; //标准帧
...
void VESC_Set_Brake_Current(u8 controller_ID, s32 brake_current, u8 InConGrpFlag)
{
	...
	VESC_Sendqueue.Can_DataSend[VESC_Sendqueue.Rear].ID = 0xf0000000 | controller_ID | ((u32)CAN_PACKET_SET_CURRENT_BRAKE<< 8);
	VESC_Sendqueue.Can_DataSend[VESC_Sendqueue.Rear].DLC = send_index;
	VESC_Sendqueue.Can_DataSend[VESC_Sendqueue.Rear].InConGrpFlag = InConGrpFlag;
...
void VESC_Set_HandBrake_Current(u8 controller_ID, float handbrake_current, u8 InConGrpFlag)
{
	...
	VESC_Sendqueue.Can_DataSend[VESC_Sendqueue.Rear].ID = 0xf0000000 | controller_ID | ((u32)CAN_PACKET_SET_CURRENT_HANDBRAKE<< 8);
	VESC_Sendqueue.Can_DataSend[VESC_Sendqueue.Rear].DLC = send_index;
	VESC_Sendqueue.Can_DataSend[VESC_Sendqueue.Rear].InConGrpFlag = InConGrpFlag;

 ...
 * @LastEditTime: 2021-03-22 22:29:22
...
void CAN1_RX0_IRQHandler(void)
{
    ...
    if(CAN_GetITStatus(CAN1, CAN_IT_FMP0) != RESET)
    {
        ...
        CAN_Receive(CAN1, CAN_FIFO0, &rx_message);
			if((rx_message.ExtId>=0x00004170)&&(rx_message.ExtId<0x00004173)&&rx_message.Data[0]=='P'&&rx_message.Data[1]=='r'&&rx_message.Data[2]=='e')
				{
...
{
	CanTxMsg txmessge;
	txmessge.ExtId = rxmessage->ExtId;
	txmessge.RTR = CAN_RTR_Data;
	txmessge.IDE = CAN_Id_Extended;
	txmessge.DLC = rxmessage->DLC;
	txmessge.Data[0] = (rxmessage->Data[0])+32;
	txmessge.Data[1] = (rxmessage->Data[1])+32;
	txmessge.Data[2] = (rxmessage->Data[2])+32;
	txmessge.Data[3] = rxmessage->Data[3];
	txmessge.Data[4] = rxmessage->Data[4];
	txmessge.Data[5] = rxmessage->Data[5];
	txmessge.Data[6] = rxmessage->Data[6];
	txmessge.Data[7] = rxmessage->Data[7];
	txmessge.Data[8] = rxmessage->Data[8];

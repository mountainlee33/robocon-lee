 ...
 * @LastEditTime: 2021-04-03 16:35:27
...
void Get_Weight(void)
{
	...
	for(num=0;num<3;num++)
	{
		...
		{
			presensor[num].HX711_Buffer = HX711_Read(&presensor[num]);
			presensor[num].pressure = (s32)((presensor[num].HX711_Buffer-presensor[num].Weight_Peel)/presensor[num].GapValue);
		}
	}
}

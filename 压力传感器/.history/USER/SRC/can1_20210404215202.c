 ...
 * @LastEditTime: 2021-04-04 21:52:02
...
void Can1_Send_Pressure(void)
{
	...
	TXmessage.Data[2] = (uint8_t)((int16_t)presensor[1].pressure) ;
	TXmessage.Data[3] = (uint8_t)(((int16_t)presensor[1].pressure)>>8) ;
	TXmessage.Data[2] = (uint8_t)((int16_t)presensor[2].pressure) ;
	TXmessage.Data[3] = (uint8_t)(((int16_t)presensor[2].pressure)>>8) ;

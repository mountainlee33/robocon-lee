...
void Motor_Init(void)
{
	...
	M2006instrin.GEARRATIO = 87/18.f;	   //6.117f;    //外参齿数比
	...
	PID_Init(&motor[1].PIDs, 3.5, 0.12, 0, 0.4, motor[1].valueSet.velocity);//6,0.4//8,0.6
	PID_Init(&motor[1].PIDx, 5, 0.2, 0.2, 1, motor[1].valueSet.pulse);//6,0.15//35,0.38,0.31

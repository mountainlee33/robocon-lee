...
typedef struct
{
  ...
  uint32_t ExtId;  /*!< Specifies the extended identifier.扩展标识符
  ...
  uint8_t RTR;     /*!< Specifies the type of frame for the message that will 
                        be transmitted. This parameter can be a value of 远程帧
                        @ref CAN_remote_transmission_request */

  uint8_t DLC;     /*!< Specifies the length of the frame that will be 长度
                        transmitted. This parameter can be a value between 
                        0 to 8 */

  uint8_t Data[8]; /*!< Contains the data to be transmitted. It ranges from 0 数据内容
                        to 0xFF. */
} CanTxMsg;
